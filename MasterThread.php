...
//        );
//        Thread::setproctitle(Daemon::$runName . ': master process' . (Daemon::$settings['pidfile'] !== Daemon::$settings['defaultpidfile'] ?
//				' (' . Daemon::$settings['pidfile'] . ')' : ''));
...
//            }
    ...
    {
        if (isset($this->collections['workers']
                ->threads[$spawnId])) {
            if (!$this->collections['workers']
                        ->threads[$spawnId]
                        ->reloaded) {
